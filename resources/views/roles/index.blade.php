              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-6" style="text-align: right;">
                    <a href=" {{route('roles.create')}} " class="btn btn-primary"><i class="nav-icon fas fa-plus"></i> Ajouter</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                    ...
                    @else
                      ...
                      @foreach($data as $item)
                        <tr>
                          ...
                          <td> {{ $item->libelle }} </td>
                          <td>
                             <a href="{{ route('roles.edit', $item->id) }}" class="btn btn-primary" title="Modifier"><i class="nav-icon fas fa-edit"></i></a>
                          </td>
                          <td>
