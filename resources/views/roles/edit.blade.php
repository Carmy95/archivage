              ...
              {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <input type="hidden" name="_method" value="PUT">
                    <label for="nom">Intituler du Role</label>
                    <input type="text" value=" {{ $data->libelle }} " class="form-control {{ $errors->first('nom','is-invalid')}} " name="nom" id="nom" placeholder="Enter le nom du role">
